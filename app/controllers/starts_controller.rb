class StartsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @start.save
        format.html { redirect_to start_url(@start), notice: 'Start was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @start.update(start_params)
        format.html { redirect_to start_url(@start), notice: 'Start was successfully updated.' }
